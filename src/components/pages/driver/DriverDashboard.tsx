        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12, flexWrap: 'wrap' }}>
              ...
              <span style={{
                display: 'inline-flex', alignItems: 'center', gap: 6,
                background: periodeAktifNama ? 'rgba(16,185,129,0.2)' : 'rgba(239,68,68,0.2)',
                border: `1px solid ${periodeAktifNama ? 'rgba(52,211,153,0.5)' : 'rgba(252,165,165,0.5)'}`,
                borderRadius: 999, padding: '4px 12px',
                fontSize: 12, fontWeight: 600, color: periodeAktifNama ? '#6ee7b7' : '#fca5a5',
              }}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" width={14} height={14}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                </svg>
                {periodeAktifNama ? `Periode: ${periodeAktifNama}` : 'Tidak ada periode aktif'}
              </span>
            </div>
          </div>
