...
export default function Sidebar({ onLogout, userRole }: SidebarProps) {
  ...
  const adminMenuItems = [
    ...
    // { href: '/admin/kategori-penilaian', label: 'Kategori Penilaian' }, // hidden per instansi request
    {
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 01-.982-2.125m0 0a9.003 9.003 0 01-9.006 0m0 0a7.456 7.456 0 00-.982 2.125" />
        </svg>
      )
    }
  ]
  ...
  const petugasMenuItems = [
    ...
    // { href: '/petugas/kategori-penilaian', label: 'Kategori Penilaian' }, // hidden per instansi request
    {
      href: '/petugas/analytics',
      label: 'Grafik & Analitik',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
        ...
        <nav className="sidebar-nav">
          {menuItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className={`nav-item ${pathname === item.href || (item.href === '/admin/kelola-data' && (pathname === '/admin/kelola-user' || pathname === '/admin/kelola-bus')) ? 'active' : ''}`}
