...
interface DashboardData {
  ...
  total_armada: number
  total_bus: number | null
  total_koridor: number | null
...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    // Card 2: super_admin → Total Bus | admin vendor → Pending Validasi
    isSuperAdmin ? {
      title: 'Total Bus Aktif',
      value: data.total_bus ?? 0,
      sub: `Seluruh armada`,
      subClass: 'neutral',
    ...
    // Card 3: super_admin → Total Koridor | admin vendor → Approved Bulan Ini
    isSuperAdmin ? {
      title: 'Total Koridor',
      value: data.total_koridor ?? 0,
      sub: `Koridor & feeder aktif`,
      subClass: 'neutral',
